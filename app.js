...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("tasks__edit-item");
    //If class of the parent is .tasks__edit-item
    if(containsClass){

        //switch to .tasks__edit-item
    ...
    //toggle .tasks__edit-item on the parent.
    listItem.classList.toggle("tasks__edit-item");
};
